...
- Модульная архитектура приложения на Cocoapods с разделением модулей по типам и c автоматическими проверками правильности построения связей между модулями.
...
UI пишут и поддерживают продуктовые разработчики, а команда платформы предоставляет для этого удобный тулинг.
...
Мы проверяем стиль кода, ресурсы приложения, локализации, использование deprecated-кода и многое другое.
...
Среднее время проверки пулл-реквеста на CI 12-15 минут, что обеспечивает достаточно быстрый фидбэк при разработке.
